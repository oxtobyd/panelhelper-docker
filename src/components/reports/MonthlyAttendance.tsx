  ...
  useEffect(() => {
    const fetchMonthlyStats = async () => {
      try {
        ...
        setError('Failed to load monthly attendance statistics');
      } finally {
        setLoading(false);
      }
    };
              ...
              <React.Fragment key={yearData.academic_year}>
                ...
                <tr className="bg-green-50/50">
                  ...
                  {monthNames.map((_, index) => {
                    ...
                    const count = monthData?.panel_candidates || 0;
                ...
                <tr className="bg-blue-50/50">
                  ...
                  {monthNames.map((_, index) => {
                    ...
                    const monthData = monthMap.get(monthNum);
                    const count = monthData?.carousel_candidates || 0;
